...
<div class="container">
        ...
        <div class="form-group">
          ...
          <input type="email" class="form-control" placeholder="name"  id="username"/>
        </div>
        <div class="form-group">
        ...
        <div class="d-flex justify-content-end">
          <button id="btn-addSearch" class="btn btn-info" onClick="goPopup();">주소검색</button>
        </div>
        <div class="d-flex justify-content-start">
             <input type="addr" class="form-control" readonly='true' id="addr" />
         </div>
         <br/>
